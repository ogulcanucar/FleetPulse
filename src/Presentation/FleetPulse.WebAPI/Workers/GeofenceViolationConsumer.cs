...
namespace FleetPulse.WebAPI.Workers
{
        ...
        ILogger<GeofenceViolationConsumer> logger) : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            var retryQueueName =
                _configuration["RabbitMQ:GeofenceViolationRetryQueue"]!;

            var deadLetterQueueName =
                _configuration["RabbitMQ:GeofenceViolationDeadLetterQueue"]!;
            ...
            consumer.ReceivedAsync += async (sender, args) =>
            {
                ...
                try
                {
                    ...
                    var violationEvent =
                        JsonSerializer.Deserialize<GeofenceViolationCreatedEvent>(json);
